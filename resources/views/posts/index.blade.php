                        ...
                        <form method="GET" action="{{ route('posts.index') }}">
                            <div class="flex items-center justify-end mb-4">
                                ...
                                <select id="category" name="category" class="border border-gray-300 rounded-md py-1 px-2">
                                    ...
                                    <option value="Current Events" {{ $category === 'Current Events' ? 'selected' : '' }}>Current Events</option>
                                    <option value="How-To-Guides" {{ $category === 'How-To-Guides' ? 'selected' : '' }}>How-To-Guides</option>
                                    <option value="Product Reviews" {{ $category === 'Product Reviews' ? 'selected' : '' }}>Product Reviews</option>
                                </select>
                                {{-- view all my post --}}
                                <label for="my-posts" class="ml-4">View all my posts:</label>
                                <input type="checkbox" id="my-posts" name="my_posts" value="1" {{ request()->has('my_posts') ? 'checked' : '' }}>
