                    ...
                    <div class="mt-6 bg-white shadow-sm rounded-lg divide-y">
                        <form method="GET" action="{{ route('comments.create', ['post_id' => request()->post_id]) }}">
                            <div class="flex items-center justify-end mb-4">
                                ...
                                <label for="my-comments" class="ml-4">View all my Comments:</label>
                                <input type="checkbox" id="my_comments" name="my_comments" value="1" onclick="this.form.submit()" {{ request()->has('my_posts') ? 'checked' : '' }}>
                            </div>
                        </form>
